var StiffEyesPatterns = (function () {
  ...
  var SCAN_TABS = [
    { id: 'jsleak', label: 'JS泄露', kind: 'jsleak' },
    { id: 'domains', label: '域名', kind: 'snow', field: 'domains', copy: true },
    { id: 'absoluteApis', label: 'API绝对路径', kind: 'snow', field: 'absoluteApis', copy: true, copyUrl: 'absolute' },
    { id: 'apis', label: 'API相对路径', kind: 'snow', field: 'apis', copy: true, copyUrl: 'relative' },
    { id: 'moduleFiles', label: '模块路径', kind: 'snow', field: 'moduleFiles', copy: true },
    { id: 'docFiles', label: '文档', kind: 'snow', field: 'docFiles', copy: true },
    { id: 'credentials', label: '账密', kind: 'snow', field: 'credentials', copy: true },
    { id: 'cookies', label: 'Cookie', kind: 'snow', field: 'cookies', copy: true },
    { id: 'idKeys', label: 'ID密钥', kind: 'snow', field: 'idKeys', copy: true },
    { id: 'secrets', label: '云Key', kind: 'snow', field: 'secrets', copy: true },
    { id: 'phones', label: '手机号', kind: 'snow', field: 'phones', copy: true },
    { id: 'emails', label: '邮箱', kind: 'snow', field: 'emails', copy: true },
    { id: 'idcards', label: '身份证', kind: 'snow', field: 'idcards', copy: true },
    { id: 'ips', label: 'IP', kind: 'snow', field: 'ips', copy: true },
    { id: 'companies', label: '公司', kind: 'snow', field: 'companies', copy: true },
    { id: 'jwts', label: 'JWT', kind: 'snow', field: 'jwts', copy: true },
    { id: 'imageFiles', label: '音图', kind: 'snow', field: 'imageFiles', copy: true },
    { id: 'githubUrls', label: 'GitHub', kind: 'snow', field: 'githubUrls', copy: true },
    { id: 'vueFiles', label: 'Vue', kind: 'snow', field: 'vueFiles', copy: true },
    { id: 'jsFiles', label: 'JS', kind: 'snow', field: 'jsFiles', copy: true },
